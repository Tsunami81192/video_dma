...
HD_PWD='E:/xilinx_axi/tp/zcu104/vdma.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Video_DMA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Video_DMA.tcl -notrace
