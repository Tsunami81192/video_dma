...
#
# Generated by export_simulation on Mon Mar 18 22:00:44 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './axi_vd.sh' script.
...
./axi_vd.sh -noclean_files

For more information on the script, please type './axi_vd.sh -help'.
