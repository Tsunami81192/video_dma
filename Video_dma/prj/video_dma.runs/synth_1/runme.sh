...
HD_PWD='D:/xilinx_prj/xilinx_axi/Video_dma/prj/video_dma.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_dma.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_dma.tcl
