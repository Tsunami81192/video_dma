...
#
# Generated by export_simulation on Fri Mar 08 17:20:06 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './axi_wr.sh' script.
...
./axi_wr.sh -noclean_files

For more information on the script, please type './axi_wr.sh -help'.
