...
HD_PWD='D:/xilinx_prj/xilinx_axi/ip_repo/axi_rd/axi_rd/axi_rd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_read.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_read.tcl -notrace
