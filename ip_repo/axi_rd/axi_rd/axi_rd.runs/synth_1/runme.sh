...
HD_PWD='D:/xilinx_prj/xilinx_axi/ip_repo/axi_rd/axi_rd/axi_rd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_read.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_read.tcl
